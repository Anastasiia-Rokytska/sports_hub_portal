...
public class TeamConfiguration {
  ...
  public void addTeams() throws IOException, SQLException {
    ...
    teamService.saveTeam(new Team("Los Angeles Lakers", "Los Angeles, California",
        34.052235, -118.243683, categoryService.getCategoryById(1L),
        categoryService.getCategoryById(5L),
        new SerialBlob(
            resourceLoader.getResource(pathToConfigImages + "LosAngelesLakers.png").getInputStream()
                .readAllBytes())));
    teamService.saveTeam(new Team("Houston Rockets", "Houston, Texas",
        29.749907, -95.358421, categoryService.getCategoryById(1L),
        categoryService.getCategoryById(6L),
        new SerialBlob(
            resourceLoader.getResource(pathToConfigImages + "HoustonRockets.png").getInputStream()
                .readAllBytes())));
    teamService.saveTeam(new Team("Memphis Grizzlies", "Memphis, Tennessee",
        35.117500, -89.971107, categoryService.getCategoryById(1L),
        categoryService.getCategoryById(5L),
        new SerialBlob(
            resourceLoader.getResource(pathToConfigImages + "MemphisGrizzlies.png").getInputStream()
                .readAllBytes())));
    teamService.saveTeam(new Team("Utah Jazz", "Salt Lake City, Utah",
        40.758701, -111.876183, categoryService.getCategoryById(1L),
        categoryService.getCategoryById(5L),
        new SerialBlob(
            resourceLoader.getResource(pathToConfigImages + "UtahJazz.png").getInputStream()
                .readAllBytes())));
