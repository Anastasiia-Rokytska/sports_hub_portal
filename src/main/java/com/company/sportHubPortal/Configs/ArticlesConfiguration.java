...
public class ArticlesConfiguration {
    ...
    public ArticlesConfiguration(ArticleService articleService) {
    ...
    public void createArticles(){
        articleService.saveArticle(new Article("London Games return in 2019",
                ...
                "admin", true, "ENG", new Date(System.currentTimeMillis()),
        ...
        articleService.saveArticle(new Article("Raiders release",
                ...
                "admin", true, "ENG", new Date(System.currentTimeMillis()),
                "After a five-year stint with the Oakland Raiders", new HashSet<>(), "assets/articlesPhoto/photo1.png"));
        articleService.saveArticle(new Article("2019",
                ...
                "admin", true, "ENG", new Date(System.currentTimeMillis()),
                "2019 NFL free agency", new HashSet<>()));
        articleService.saveArticle(new Article("Lorem ipsum 1",
                ...
                "admin", true, "ENG", new Date(System.currentTimeMillis()),
                "Lorem ipsum dolor sit amet, consectetur", new HashSet<>(), "assets/articlesPhoto/photo2.png"));
        articleService.saveArticle(new Article("Lorem ipsum 2",
                ...
                "admin", true, "ENG", new Date(System.currentTimeMillis()),
                "Lorem ipsum dolor sit amet, consectetur", new HashSet<>(), "assets/articlesPhoto/photo3.png"));
        articleService.saveArticle(new Article("Lorem ipsum 3",
                "\n" +
                ...
                "admin", true, "ENG", new Date(System.currentTimeMillis()),
                "Lorem ipsum dolor sit amet, consectetur", new HashSet<>(), "assets/articlesPhoto/photo4.png"));
        articleService.saveArticle(new Article("Lorem ipsum 4",
                ...
                "admin", true, "ENG", new Date(System.currentTimeMillis()),
                "Lorem ipsum dolor sit amet, consectetur", new HashSet<>(), "assets/articlesPhoto/photo5.png"));
        ...
        articleService.saveArticle(new Article("Lorem ipsum 6",
                ...
                "admin", true, "ENG", new Date(System.currentTimeMillis()),
                "Lorem ipsum dolor sit amet, consectetur", new HashSet<>(), "assets/articlesPhoto/photo6.png"));
        articleService.saveArticle(new Article("Lorem ipsum 7",
                ...
                "admin", true, "ENG", new Date(System.currentTimeMillis()),
                "Lorem ipsum dolor sit amet, consectetur", new HashSet<>(), "assets/articlesPhoto/photo1.png"));
