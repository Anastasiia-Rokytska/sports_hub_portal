...
public class ArticlesConfiguration {
  ...
  public void createArticles() throws IOException, SQLException {
    ...
    articleService.saveArticle(new Article("Raiders release",
        ...
        "admin", true, true, "ENG", new Date(System.currentTimeMillis()),
        "After a five-year stint with the Oakland Raiders", new SerialBlob(
        resourceLoader.getResource(pathToConfigImages + "photo1.png").getInputStream()
            .readAllBytes()), new HashSet<>()));
    articleService.saveArticle(new Article("2019",
        ...
        "admin", true, true, "ENG", new Date(System.currentTimeMillis()),
        "2019 NFL free agency", new SerialBlob(
        resourceLoader.getResource(pathToConfigImages + "photo2.png").getInputStream()
            .readAllBytes()), new HashSet<>()));
    ...
    articleService.saveArticle(new Article("Lorem ipsum 2",
        ...
        "admin", true, true, "ENG", new Date(System.currentTimeMillis()),
        "Lorem ipsum dolor sit amet, consectetur", new SerialBlob(
        resourceLoader.getResource(pathToConfigImages + "photo3.png").getInputStream()
            .readAllBytes()), new HashSet<>()));
    articleService.saveArticle(new Article("Lorem ipsum 3",
        ...
        "admin", true, true, "ENG", new Date(System.currentTimeMillis()),
        "Lorem ipsum dolor sit amet, consectetur", new SerialBlob(
        resourceLoader.getResource(pathToConfigImages + "photo4.png").getInputStream()
            .readAllBytes()), new HashSet<>()));
    articleService.saveArticle(new Article("Lorem ipsum 4",
        ...
        "admin", true, true, "ENG", new Date(System.currentTimeMillis()),
        "Lorem ipsum dolor sit amet, consectetur", new SerialBlob(
        resourceLoader.getResource(pathToConfigImages + "photo5.png").getInputStream()
            .readAllBytes()), new HashSet<Category>()));
    articleService.saveArticle(new Article("Lorem ipsum 5",
        ...
        "admin", true, true, "ENG", new Date(System.currentTimeMillis()),
        "Lorem ipsum dolor sit amet, consectetur", new SerialBlob(
        resourceLoader.getResource(pathToConfigImages + "photo6.png").getInputStream()
            .readAllBytes()), new HashSet<>()));
