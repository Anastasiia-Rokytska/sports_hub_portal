...
public class Article {
  ...
  public Article(String title, String content, String author, boolean commentable, String language,
                 Date publishedDate, String caption, Set<Category> categories, MultipartFile icon)
  ...
  public Article(String title, String content, String author, boolean commentable, String language,
                 Date publishedDate, String caption, Set<Category> categories, Blob icon) {
    this.title = title;
    this.content = content;
    this.author = author;
    this.commentable = commentable;
  ...
  public Article(String title, String content, String user, boolean commentable, String language,
                 String caption) {
    this.title = title;
    this.content = content;
    this.author = user;
